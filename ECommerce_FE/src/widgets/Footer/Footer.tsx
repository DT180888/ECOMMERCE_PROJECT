  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ height: MIN_H }}
      >
        <div className="background-glass flex items-center justify-between px-2 md:px-3 w-full h-full rounded-t-xl">
      ...
      <div
        id="footer-panel"
        className="mx-auto max-w-[1600px] px-4 md:px-6 text-sm text-white/90 overflow-hidden "
        style={{
      ...
      >
        <div className="background-glass">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 py-4 px-3">
            <section>
          ...
          <div className="border-t border-white/15 py-3 px-3 text-[12px] text-white/70">
