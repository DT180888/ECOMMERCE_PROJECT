...
export function useCheckoutPreview(params: {
  ...
  return useQuery<CheckoutPreviewDto>({
    ...
    queryFn: () =>
      getCheckoutPreview({
        shipToAddressId: params.shipToAddressId!, // Non-null assertion an toÃ n vÃ¬ enabled = true
