...
/** Từ danh sách SKU, suy ra nhóm thuộc tính (attribute) và các giá trị khả dụng */
...
/** Tìm SKU khớp theo pick biến thể (tất cả attribute/value phải khớp) */
export function resolveSkuByPick(skus: Sku[] | undefined, pick: Record<number, string> | undefined) {
  ...
  return skus.find((s) => {
    ...
    // cũng cần đảm bảo không có attribute nào trong pick bị thiếu trong SKU
